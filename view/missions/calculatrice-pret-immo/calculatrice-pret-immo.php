<section class="full-h">
    ...
    <h3 class="text-center fw-semibold pt-4">Tâches réalisées</h3>
        <ul class="dynamic-paragraph d-flex flex-column justify-content-center align-items-center p-0 m-auto text-center">
            ...
            <li class="d-flex"><p>Encapsulation en client lourd via Eletron JS</p></li>
        </ul>
    ...
    <div class="d-flex justify-content-center  pb-4">
        <a href="https://mattisbbn.github.io/Calculette-pret-immobilier/" target="_blank" class="text-white fw-medium dynamic-paragraph bg-blue p-3 m-1 rounded-3 land-icons border-0">Acceder au site</a>
    </div>
