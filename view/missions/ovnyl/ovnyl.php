<section class="full-h">
    ...
    <div class="col-12 d-flex">
        <img class="col-11 col-xl-6 mt-4 m-auto project-img rounded-4" src="public/img/projects/ovnyl.png" alt="">
    </div>
    ...
    <h3 class="text-center fw-semibold pt-4">Tâches réalisées</h3>
        <ul class="dynamic-paragraph d-flex flex-column justify-content-center align-items-center p-0 m-auto text-center">
            <li class="d-flex"><p>Débug php 5.4 vers php 8.2</p></li>
            ...
            <li class="d-flex"><p>Refactorisation partielle panel admin</p></li>
        </ul>

        <h3 class="text-center fw-semibold pt-2">Contexte</h3>
        <p class="dynamic-paragraph text-center">
            Projet pour un client à <a href="./entreprise">Akoufen</a>, refonte totale front-end via maquette Figma + mise à jour du code vers PHP 8.2.</p>
