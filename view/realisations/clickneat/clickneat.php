    ...
    <div class="col-6 m-auto">
        ...
        <h3 class="text-center fw-semibold  my-4">Fonctionnalités MVP (Minimum Viable Product)</h3>
            <ul>
                ...
                <li><p class="dynamic-paragraph ">Authentification des utilisateurs </p></li>
                <li><p class="dynamic-paragraph ">Accès spécifique restaurant </p></li>
                <li><p class="dynamic-paragraph ">Accès spécifique client </p></li>
                <li><p class="dynamic-paragraph ">Gestion de la carte/des menus (classification des articles au menu par catégorie) </p></li>
                <li><p class="dynamic-paragraph ">Gestion des commandes</p></li>
            </ul>
       
        <h3 class="text-center fw-semibold  my-4">Fonctionnalités MLP (Minimum Lovable Product)</h3>
            <ul>
                <li><p class="dynamic-paragraph ">Génération d’un lien d’accès à la commande de chaque carte de restaurant via un QR code</p></li>
                <li><p class="dynamic-paragraph ">Responsive</p></li>
                <li><p class="dynamic-paragraph ">Paramétrage de la charte graphique du restaurant pour sa carte</p></li>
                <li><p class="dynamic-paragraph ">Paiement en ligne via API Stripe (avantages : package Laravel cashier, voir doc)</p></li>
            </ul>
        ...
        <h3 class="text-center fw-semibold  my-4">Contraintes techniques</h3>
            <ul>
                ...
                <li><p class="dynamic-paragraph ">Tests unitaires</p></li>
            </ul>
