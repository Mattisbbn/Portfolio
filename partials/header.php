        ...
        <nav class="nav container">
            ...
            <div class="nav_menu" id="nav-menu">
                <ul class="nav_list grid">
                    <li class="nav_item">
                        <a onclick="showPage('accueil')" class="nav_link active-link">
                            <i class="uil uil-estate nav_icon"></i>Accueil
                        </a>
                    </li>
                    <li class="nav_item">
                        <a onclick="showPage('entreprise')"  class="nav_link">
                            <i class="uil uil-user nav_icon"></i>Entreprise
                        </a>
                    </li>
                    <li class="nav_item">
                        <a onclick="showPage('veille')" class="nav_link">
                            <i class="uil uil-file-alt nav_icon"></i>Veille
                        </a>
                    </li>
                    <li class="nav_item">
                    ...
                    <li class="nav_item">
                        <a onclick="showPage('projets')"   class="nav_link">
                            <i class="uil uil-scenery nav_icon"></i>Projets
                        </a>
                    </li>
                    <li class="nav_item">
