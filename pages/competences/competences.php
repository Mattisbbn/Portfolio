    ...
    <div class="skills_container container grid">
        ...
        <div class="skills_content skills_open">
            <div class="skills_header">
                ...
                <div>
                    <h1 class="skills_title">Programmation</h1>
                    <span class="skills_subtitle">Highly Experienced</span>
                </div>
        ...
        <div class="skills_content skills_close">
            <div class="skills_header">
                <i class="uil uil-dashboard skills_icon"></i>
                <div>
                    <h1 class="skills_title">Other Skills</h1>
                    <span class="skills_subtitle">Experienced</span>
                </div>
                <i class="uil uil-angle-down skills_arrow"></i>
            </div>
            <div class="skills_list grid">
                ...
                <div class="skills_data">
                    ...
                    <div class="skills_bar">
                        <span class="skills_percentage skills_tailwind"></span>
                    </div>
                </div>
                <div class="skills_data">
                    <div class="skills_titles">
                ...
                <div class="skills_data">
                    <div class="skills_titles">
                        <h3 class="skills_name">LODASH</h3>
                        <span class="skills_number">70%</span>
                    </div>
                    <div class="skills_bar">
                        <span class="skills_percentage skills_lodash"></span>
                    </div>
                </div>

                <div class="skills_data">
                    <div class="skills_titles">
                        <h3 class="skills_name">REDUX</h3>
                        <span class="skills_number">70%</span>
                    </div>
                    <div class="skills_bar">
                        <span class="skills_percentage skills_redux"></span>
                    </div>
                </div>

                <div class="skills_data">
                    <div class="skills_titles">
                        <h3 class="skills_name">JEST</h3>
                        <span class="skills_number">60%</span>
                    </div>
                    <div class="skills_bar">
                        <span class="skills_percentage skills_jest"></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="skills_content skills_close">
            <div class="skills_header">
                <i class="uil uil-code-branch skills_icon"></i>
                <div>
                    <h1 class="skills_title">Outils</h1>
                    <span class="skills_subtitle">Fairly Experienced</span>
                </div>
                <i class="uil uil-angle-down skills_arrow"></i>
            </div>
            <div class="skills_list grid">
                ...
                <div class="skills_data">
                    ...
                    <div class="skills_bar">
                        <span class="skills_percentage skills_git"></span>
                    </div>
                </div>
                ...
                <div class="skills_data">
                    ...
                    <div class="skills_bar">
                        <span class="skills_percentage jira"></span>
                    </div>
                </div>
