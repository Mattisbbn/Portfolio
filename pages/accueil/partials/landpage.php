            ...
            <div class="home_content">
                    <div class="home_data">
                        ...
                        <a href="https://drive.google.com/uc?export=download&id=1Mv1h-ibSDed5oK9ehfItn-Ra-kHWzVUH" class="button button--flex">
                            Mon CV<i class="uil  uil-download-alt button_icon"></i>
                        </a>
                        <a href="https://github.com/Mattisbbn" target="_blank" class="button button--flex">
                            Github<i class="uil uil-github button_icon"></i>
                        </a>
